"""
Test serialization and deserialization for ImportancePruningStrategy.
"""
...
def test_serialization():
    ...
    comp_config = CompressionConfig(
        strategies=[strategy],
        description="Test importance pruning",
    )
    ...
    assert isinstance(comp_deserialized.strategies[0], ImportancePruningStrategy)
